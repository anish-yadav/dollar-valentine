  ...
  return (
    <Link href="/" >
      <Flex flexDirection="row" alignItems="center" {...props}>
        <Icon viewBox="0 0 69 59" width="50px" height="25px" fill="none">
          <path
        ...
        <Text fontWeight="bold" fontSize="34px" color="primary.900">
          Valentine.
        </Text>
        <Text fontWeight="bold" fontSize="34px" color="primary.400">
          me
        </Text>
      </Flex>
    </Link>
